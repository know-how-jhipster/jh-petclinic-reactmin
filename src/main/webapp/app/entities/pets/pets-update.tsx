        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? <ValidatedField name="id" required readOnly id="pets-id" label="ID" validate={{ required: true }} /> : null}
              <ValidatedField
                label="Name"
                id="pets-name"
                name="name"
              ...
              />
              <ValidatedField id="pets-type" name="type" data-cy="type" label="Type" type="select">
                <option value="" key="0" />
                {types
              ...
              <ValidatedField id="pets-owner" name="owner" data-cy="owner" label="Owner" type="select">
                <option value="" key="0" />
                {owners
