...
import org.ujar.jh.petclinic.reactmin.repository.VisitsRepository;
import org.ujar.jh.petclinic.reactmin.service.VisitsService;
import org.ujar.jh.petclinic.reactmin.service.dto.VisitsDTO;
...
/**
 * REST controller for managing {@link org.ujar.jh.petclinic.reactmin.domain.Visits}.
 */
@RestController
@RequestMapping("/api")
public class VisitsResource {
    ...
    public ResponseEntity<VisitsDTO> updateVisits(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, visitsDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<VisitsDTO> partialUpdateVisits(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, visitsDTO.getId().toString())
        );
    }
