...
import dev.knowhowto.jh.petclinic.reactmin.repository.PetsRepository;
import dev.knowhowto.jh.petclinic.reactmin.service.PetsService;
...
/**
 * REST controller for managing {@link dev.knowhowto.jh.petclinic.reactmin.domain.Pets}.
 */
@RestController
@RequestMapping("/api")
public class PetsResource {
    ...
    public ResponseEntity<PetsDTO> updatePets(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, petsDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<PetsDTO> partialUpdatePets(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, petsDTO.getId().toString())
        );
    }
