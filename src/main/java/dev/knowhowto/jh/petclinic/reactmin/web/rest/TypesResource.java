...
import dev.knowhowto.jh.petclinic.reactmin.repository.TypesRepository;
import dev.knowhowto.jh.petclinic.reactmin.service.TypesService;
...
/**
 * REST controller for managing {@link dev.knowhowto.jh.petclinic.reactmin.domain.Types}.
 */
@RestController
@RequestMapping("/api")
public class TypesResource {
    ...
    public ResponseEntity<TypesDTO> updateTypes(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, typesDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<TypesDTO> partialUpdateTypes(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, typesDTO.getId().toString())
        );
    }
